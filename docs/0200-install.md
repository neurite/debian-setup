...
15. `Select and install software`
    ...
    * Note, if you want to install a lightweight desktop, make sure **do not select any desktop environment**. We will install a lightweight desktop at a later stage. For example, [a minimal GNOME desktop](0601-gnome.md).
